...
// console.log(factor);
// console.log(num); // 에러, 스코프안에서 let으로 선언된 신규 변수는 못나오고, var로 선언된 신규변수는 나온다. var예약어는 함수스코프를 가지기 때문이다. let은 블로스코프(블록변수)를 가진다.
...
// 블록스코프
{
  // const num = 10; // 여기에 선언된 num은 해당 블록스코프 밖에 나갈 수 없다. calc()에 반영될 수 없다.  

  // let result = calc(); // 걍 함수를 변수에 할당하고 
  // console.log(`result : ${result} `); // 변수로 부름
